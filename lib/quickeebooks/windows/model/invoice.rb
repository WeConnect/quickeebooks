            ...
            xml.Add('FullResponse' => "true",  'xmlns' => "http://www.intuit.com/sb/cdm/v2",  'xmlns:xsi' => "http://www.w3.org/2001/XMLSchema-instance", 'RequestId' => "#{ SecureRandom.hex}",  'xsi:schemaLocation' => "http://www.intuit.com/sb/cdm/V2./RestDataFilter.xsd") do
              ...
              xml.Invoice do
                xml.Header do
                  ...
                  xml.CustomerName header.customer_name unless header.customer_name.blank?
                  ...
                  if header.billing_address
                    xml.BillAddr do
                      ...
                      xml.City   header.billing_address.city if header.billing_address.city
                      xml.Country header.billing_address.country if header.billing_address.country
                      xml.PostalCode header.billing_address.postal_code if header.billing_address.postal_code
